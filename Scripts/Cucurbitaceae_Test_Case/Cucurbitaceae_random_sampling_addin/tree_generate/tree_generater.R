...
#write out 10 random trees with each of 10, 30, 50, 75 percentage tips dropped from the original 528-tip Cucurbitaceae_5g.tre.
# also write out which tips are dropped
